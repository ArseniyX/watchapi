...
describe("OrganizationService", () => {
  ...
  describe("createOrganization", () => {
    it("should create organization and add creator as owner", async () => {
      ...
      expect(mockRepository.findOrganizationBySlug).toHaveBeenCalledWith(
        "test-org",
      );
    ...
    it("should throw error if slug already exists", async () => {
      mockRepository.findOrganizationBySlug.mockResolvedValue({
        id: "existing-org",
      });
  ...
  describe("updateOrganization", () => {
    it("should update organization if user has admin permission", async () => {
      ...
      expect(mockRepository.updateOrganization).toHaveBeenCalledWith(
        "org-1",
        updateData,
      );
  ...
  describe("checkMemberPermission", () => {
    it("should return true for owner with any permission", async () => {
      ...
      const result = await service.checkMemberPermission(
        "user-1",
        "org-1",
        OrganizationRole.MEMBER,
      );
  ...
  describe("getUserOrganizations", () => {
    it("should return all organizations for user", async () => {
      ...
      expect(mockRepository.findUserOrganizations).toHaveBeenCalledWith(
        "user-1",
      );
