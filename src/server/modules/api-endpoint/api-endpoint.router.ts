...
export const createApiEndpointRouter = (apiEndpointService: ApiEndpointService) =>
  router({
    ...
    getOrganizationEndpoints: protectedProcedure
      ...
      .query(async ({ input }) => {
        return apiEndpointService.getOrganizationApiEndpoints(input.organizationId)
      }),
    ...
    update: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        return apiEndpointService.updateApiEndpoint(ctx.user.id, id, updateData)
      }),

    delete: protectedProcedure
      .input(z.object({ id: z.string() }))
      .mutation(async ({ input, ctx }) => {
        return apiEndpointService.deleteApiEndpoint(ctx.user.id, input.id)
      }),
  })
