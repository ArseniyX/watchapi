        ...
        <div className="flex h-full flex-col">
            ...
            <div className="flex items-center gap-4 border-b border-border bg-card px-4 py-2 min-h-[40px]">
                ...
                <div className="w-24 shrink-0">
                    <Select value={rawType} onValueChange={onRawTypeChange} disabled={bodyType !== "raw"}>
                        <SelectTrigger className="h-7 w-24 text-xs" style={{ visibility: bodyType === "raw" ? "visible" : "hidden" }}>
                            <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
