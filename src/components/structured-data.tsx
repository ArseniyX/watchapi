export function StructuredData() {
  const structuredData = {
    ...
    offers: [
      ...
      },
      {
        ...
        priceCurrency: 'USD',
        name: 'Team Plan',
        description: '50 endpoints, 1-minute checks, 30-day history, team collaboration',
      },
      {
        '@type': 'Offer',
        price: '99',
        priceCurrency: 'USD',
        name: 'Business Plan',
        description: 'Unlimited endpoints, 30-second checks, 90-day history, priority support',
      },
    ],
    aggregateRating: {
  ...
  const organizationData = {
    ...
    sameAs: [
      'https://twitter.com/watchapi',
      'https://github.com/watchapi',
    ],
    contactPoint: {
      '@type': 'ContactPoint',
