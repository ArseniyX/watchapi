        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              We collect information you provide directly to us when you create an account, configure API endpoints for monitoring,
              or contact us for support.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>Account information (email, name, password)</li>
              <li>API endpoint configurations (URLs, headers, expected responses)</li>
              <li>Monitoring data (response times, status codes, uptime statistics)</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>Send you alerts and notifications about your API endpoints</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>API credentials and sensitive headers are encrypted at rest</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              We retain your monitoring data according to your subscription plan:
            </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              <a href="mailto:privacy@apimonitor.com" className="text-primary hover:underline">
                privacy@apimonitor.com
              </a>
            </p>
          </section>
        </div>
