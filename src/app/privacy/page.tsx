                ...
                <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed mb-4">
                            ...
                            when you create an account, configure API endpoints
                            for monitoring, or contact us for support.
                        </p>
                        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                            <li>Account information (email, name, password)</li>
                            <li>
                                API endpoint configurations (URLs, headers,
                                expected responses)
                            </li>
                            <li>
                                Monitoring data (response times, status codes,
                                uptime statistics)
                            </li>
                            <li>
                                Usage data (features used, monitoring activity)
                            </li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                            <li>
                                Provide and maintain our API monitoring services
                            </li>
                            <li>
                                Send you alerts and notifications about your API
                                endpoints
                            </li>
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed mb-4">
                            ...
                            industry-standard measures to protect your
                            information:
                        </p>
                        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                            <li>
                            ...
                            <li>
                                API credentials and sensitive headers are
                                encrypted at rest
                            </li>
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            We retain your monitoring data according to your
                            subscription plan:
                        </p>
                        <ul className="list-disc pl-6 space-y-2 text-muted-foreground mt-4">
                            ...
                            <li>
                                Business plan: 90 days of monitoring history
                            </li>
                        </ul>
                        <p className="text-muted-foreground leading-relaxed mt-4">
                            Account information is retained until you delete
                            your account.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            and remember your preferences. We do not use
