        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing or using APIMonitor, you agree to be bound by these Terms of Service. If you do not
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              APIMonitor provides API monitoring and testing services, including:
            </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>Use the service to monitor APIs without proper authorization</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              We target 99.9% uptime but are not liable for service interruptions.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Your use of the service is also governed by our Privacy Policy. We collect and use data as described
              in that policy. You retain all rights to your data and can export or delete it at any time.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              The service, including all software, design, and content, is owned by APIMonitor and protected by
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>We are not responsible for damages caused by your API endpoints or third-party services</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              You agree to indemnify and hold harmless APIMonitor from any claims, damages, or expenses arising
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              These terms are governed by the laws of the jurisdiction where APIMonitor is registered. Any disputes
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              <a href="mailto:legal@apimonitor.com" className="text-primary hover:underline">
                legal@apimonitor.com
              </a>
            </p>
          </section>
        </div>
