...
const plans = [
  {
    ...
    priceId: "free",
    features: [
      { icon: Database, text: "Up to 10 endpoints" },
      { icon: Users, text: "Up to 3 team members" },
      { icon: Clock, text: "Hourly health checks" },
  ...
  },
  {
    ...
    popular: true,
    features: [
      { icon: Database, text: "Up to 50 endpoints" },
  ...
  },
  {
    ...
    priceId: "pro",
    features: [
      { icon: Database, text: "Up to 200 endpoints" },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: Clock, text: "30-second checks" },
      { icon: TrendingUp, text: "Unlimited retention" },
