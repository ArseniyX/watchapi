...
export const metadata: Metadata = {
  title: {
    default:
      "WatchAPI - Affordable API Monitoring & Uptime Tracking for Small Teams",
    template: "%s | WatchAPI",
  },
  description:
  ...
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_APP_URL || "https://watchapi.dev",
  ),
  alternates: {
    canonical: "/",
  },
  openGraph: {
    ...
    title:
      "WatchAPI - Affordable API Monitoring & Uptime Tracking for Small Teams",
    description:
      "Lightweight API monitoring and uptime tracking platform for development teams. Real-time alerts, performance analytics, and API testing - a simpler, more affordable alternative to Postman and DataDog.",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
  ...
  twitter: {
    ...
    description:
      "Lightweight API monitoring platform for small teams. Real-time alerts, performance analytics, and uptime tracking.",
    images: ["/og-image.png"],
    creator: "@watchapi",
  },
  robots: {
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="WatchAPI" />
